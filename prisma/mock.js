...
export const STARTUPS = [
  {
    ...
    employees: 50,
    description:
      "프로그래밍, 웹 개발, 파이썬, 데이터 사이언스 등 다양한 분야의 강의를 실무 중심의 맞춤형 학습 과정과 실전 프로젝트를 통해 제공하는 온라인 교육 플랫폼입니다.",
    selectedCount: 0,
    comparedCount: 0,
  ...
  },
  {
    ...
    employees: 100,
    description:
      "가장 효과적인 교육을 전 세계 모두에게 - 50여 개 국가에서 매월 1천만 명의 학생이 사용하는 No. 1 교육 서비스 콴다를 만듭니다.",
    selectedCount: 0,
    comparedCount: 0,
  ...
  },
  {
    ...
    employees: 70,
    description:
      "편리한 올인원 AI 교육 플랫폼. 인터랙티브 실습환경부터 스마트한 AI 학습 관리 시스템까지 한 번에! AI 기능으로 차별화된 학습 플랫폼을 제공합니다",
    selectedCount: 0,
    comparedCount: 0,
  ...
  },
  {
    ...
    employees: 400,
    description:
      "부동산 정보 검색과 아파트 관리 서비스를 제공하는 플랫폼으로, 사용자가 손쉽게 매물 검색과 부동산 관련 정보를 확인할 수 있도록 돕는 혁신적인 부동산 솔루션을 제공합니다.",
    selectedCount: 0,
    comparedCount: 0,
  ...
  },
  {
    ...
    name: "쿠팡",
    categoryId: 2,
    actualInvest: 600000000,
    simInvest: 0,
    revenue: 230000000,
    employees: 2000,
    description:
      "쿠팡은 다양한 상품을 빠르고 편리하게 구매할 수 있는 전자상거래 플랫폼으로, 특히 로켓배송 서비스를 통해 빠른 배송과 높은 고객 만족도를 제공하고 있습니다. 첨단 기술과 물류 인프라를 바탕으로 사용자에게 최적화된 쇼핑 경험을 제공합니다.",
    selectedCount: 0,
    comparedCount: 0,
